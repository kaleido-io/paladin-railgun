...
/// new smart contracts instances that are part of a single domain.
...
interface IPaladinContractRegistry_V0 {
    ...
    /// @param config encoded parameters that all nodes functioning against this smart contract instance need to know
